from transformers import GPT2Tokenizer, GPT2LMHeadModel, AutoTokenizer, AutoModelForCausalLM, FlaxGPT2LMHeadModel
import torch

# tokenizer = AutoTokenizer.from_pretrained("personaGPT/")
# moel = AutoModelForCausalLM.from_pretrained("personaGPT/")
